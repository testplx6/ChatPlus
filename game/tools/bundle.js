...
const MODULES = [
  ...
  // Les pactes entre drapeaux : ils lisent les factions — dont la levée d'une
  // colonne, pour le secours — et le registre des faits. Placés AVANT
  // influence.js, qui les lit en retour : on ne déclare pas la guerre à qui
  // l'on a juré de ne pas attaquer.
  'pactes.js',
  'influence.js',
...
<link href="https://fonts.googleapis.com/css2?family=Big+Shoulders+Display:wght@600;700&family=IBM+Plex+Mono:wght@400;600&family=IBM+Plex+Serif:ital,wght@0,400;0,600;1,400&display=swap" rel="stylesheet" media="print" onload="this.media='all'">
<style>
${css.trim()}
</style>
</head>
