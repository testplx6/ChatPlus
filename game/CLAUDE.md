...
| `PACTES.md` | les pactes entre drapeaux — **ouvert** : pas un menu d'alliances toutes faites mais un système de clauses qu'on propose, qu'on accepte si l'on y trouve son compte, et qu'on tient ou trahit ; trois lots |
