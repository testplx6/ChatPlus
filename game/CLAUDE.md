...
| `PACTES.md` | les pactes entre drapeaux — **ouvert** : pas un menu d'alliances toutes faites mais un système de clauses qu'on propose, qu'on accepte si l'on y trouve son compte, et qu'on tient ou trahit. **P1 et P2 livrés** : les pactes existent et les deux clauses qui comptent mordent — ne pas s'attaquer, se porter secours (et manquer par impuissance n'est pas manquer par choix). **P3 est un blocage** : les conseils savent signer, mais le monde en sort déstabilisé (masse 3,0 → 5,6 M, une monnaie à 312, 35 villes de moins) — écrit, mesuré, retiré ; la piste de l'entretien des relations est **réfutée au banc**, la suivante est le coût du secours promis sans les moyens de le tenir |
