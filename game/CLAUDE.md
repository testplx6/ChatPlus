...
| `ALLURE.md` | l'étude « AAA textuel » — diagnostic, direction artistique ; **quick wins Q1–Q7 et pistes moyennes M1–M6 livrés** (carte vivante, grands moments, journal raconté, icônes dessinées, salle des cartes — limites dites dans « L'avancement »), pistes grosses G1–G3 en attente |
